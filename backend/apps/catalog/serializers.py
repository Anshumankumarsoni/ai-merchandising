...
class ProductListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            "price", "inventory_count", "is_low_stock", "marketplace", "created_at",
        )
...
class ProductDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            "brand", "brand_id", "price", "inventory_count", "is_low_stock",
            "marketplace", "created_by_email", "created_at", "updated_at",
        )
...
class InventoryUpdateSerializer(serializers.Serializer):
    ...
    change_reason = serializers.CharField(max_length=300, required=False, allow_blank=True)


class InventoryLogSerializer(serializers.ModelSerializer):
    class Meta:
        model = InventoryLog
        fields = ("id", "product", "previous_count", "new_count", "change_reason", "created_at")
